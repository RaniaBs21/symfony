 ...
 */
final class Version20230405202030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE points CHANGE id id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE quiz CHANGE reponse_correcte reponse_correcte VARCHAR(100) NOT NULL, CHANGE id admin_id INT NOT NULL');
        $this->addSql('ALTER TABLE quiz ADD CONSTRAINT FK_A412FA92642B8210 FOREIGN KEY (admin_id) REFERENCES admin (id)');
        $this->addSql('CREATE INDEX IDX_A412FA92642B8210 ON quiz (admin_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_items (Id_Cart_Item INT NOT NULL, Id_Cart INT NOT NULL, Quantite INT NOT NULL) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE points CHANGE id id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE quiz DROP FOREIGN KEY FK_A412FA92642B8210');
        $this->addSql('DROP INDEX IDX_A412FA92642B8210 ON quiz');
        $this->addSql('ALTER TABLE quiz CHANGE reponse_correcte reponse_correcte VARCHAR(100) DEFAULT NULL, CHANGE admin_id id INT NOT NULL');
